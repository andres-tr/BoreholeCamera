...
with open("/home/parallels/SanMiguelito_Gyro4.csv", "r") as f:
	i = 0
	with rosbag.Bag('/home/parallels/SanMiguelito_Gyro4.bag', 'w') as bag:
		reader = csv.reader(f)
		for row in reader:
			msg = Imu()
			...
			#t = rospy.Time.from_sec(1548444839.073 + float(row[2]))
